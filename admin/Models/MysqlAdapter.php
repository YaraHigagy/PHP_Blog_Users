...
class MysqlAdapter
{
    ...
    /**
     * Perform a Login Query statement
     */
    public function login($table, $fields = '*', $where_email = '', $where_password = '')
    {
        // $query = 'SELECT ' . $fields . ' FROM ' . $table
        //         . (($where_email) ? ' WHERE ' . $where_email : '')
        //         . ' AND '
        //         . (($where_password) ? $where_password : '');
        // $query = 'SELECT ' . $fields . ' FROM ' . $table
        // . (($where_email) ? ' WHERE email = ' . $where_email : '')
        // // . ' AND '
        // . (($where_password) ? ' AND password = ' . $where_password : '')
        // . (($limit) ? ' LIMIT ' . $limit : '');
    ...
    /**
     * Close explicitluy the database connection
     */
